...
import { deleteAccountModal } from "./modules/delete-account";
...
if (typeof deleteModalBtn !== "undefined" && deleteModalBtn !== null) {
  deleteModalBtn.addEventListener("click", deleteAccountModal);
}
